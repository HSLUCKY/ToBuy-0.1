package com.focustech.tobuy.ui.personcenter.adapter.search;
...
public class SearchRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public class SimpleGoodsViewHolder extends RecyclerView.ViewHolder {
        GuideSortedComponent.SimpleGoods simpleGoods;
